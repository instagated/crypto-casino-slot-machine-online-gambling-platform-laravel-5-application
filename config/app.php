...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Crypto Casino'),
    ...
    */
    ...
    'api' => [
        'releases' => [
            'base_uri' => env('API_RELEASES_BASE_URI', 'https://cryptocasino.financialplugins.com/api/')
        ],
        'products' => [
    ...
    */
    ...
    'debug_blacklist' => [
        '_ENV' => [
            ...
            'GAME_AMERICAN_ROULETTE_PURCHASE_CODE',
